            ...
            <div className="flex-1 min-w-0 w-full md:w-auto">
              ...
              <div className="mb-6 sm:mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
                  {/* Live Chat */}
                  <div className="flex-1 bg-gradient-to-r from-purple-100 to-purple-50 rounded-lg p-4 sm:p-6 border border-purple-200">
                  ...
                  {/* Email Support */}
                  <div className="flex-1 bg-gradient-to-r from-green-100 to-green-50 rounded-lg p-4 sm:p-6 border border-green-200">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {filteredCategories.map((category, index) => (
                  <Link
                    ...
                    className="bg-white rounded-lg border border-gray-100 p-4 sm:p-6 hover:border-gray-200 transition-colors cursor-pointer group block"
                  >
