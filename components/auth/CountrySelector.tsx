...
// Comprehensive list of all countries with their ISO codes and flag emojis
const countries = [
  ...
  return (
    <div className="relative">
      ...
      <Button
        ...
        className="w-full justify-between form-placeholder h-10 px-3 py-2 text-sm"
      >
        {selectedCountry ? (
              ...
              filteredCountries.map((country) => (
                <button
                  ...
                  className={cn(
                    ...
                    value === country.code && "bg-gray-100"
                  )}
                >
                  <span>{country.flag}</span>
                  <span>{country.name}</span>
                  {value === country.code && (
                    <Check className="ml-auto h-4 w-4 text-primary-green" />
                  )}
                </button>
              ))
            )}
